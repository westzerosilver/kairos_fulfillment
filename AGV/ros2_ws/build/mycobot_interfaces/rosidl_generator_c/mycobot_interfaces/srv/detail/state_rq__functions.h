...
#ifndef MYCOBOT_INTERFACES__SRV__DETAIL__STATE_RQ__FUNCTIONS_H_
#define MYCOBOT_INTERFACES__SRV__DETAIL__STATE_RQ__FUNCTIONS_H_
...
/// Initialize srv/StateRQ message.
/**
...
/// Create srv/StateRQ message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mycobot_interfaces__srv__StateRQ_Request__init().
...
/// Destroy srv/StateRQ message.
/**
 * It calls
 * mycobot_interfaces__srv__StateRQ_Request__fini()
...
/// Check for srv/StateRQ message equality.
/**
...
/// Initialize array of srv/StateRQ messages.
/**
...
/// Finalize array of srv/StateRQ messages.
/**
 * It calls
 * mycobot_interfaces__srv__StateRQ_Request__fini()
...
/// Create array of srv/StateRQ messages.
/**
 * It allocates the memory for the array and calls
 * mycobot_interfaces__srv__StateRQ_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StateRQ messages.
/**
 * It calls
 * mycobot_interfaces__srv__StateRQ_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/StateRQ message array equality.
/**
...
/// Copy an array of srv/StateRQ messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mycobot_interfaces__srv__StateRQ_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mycobot_interfaces
...
/**
 * It calls
 * mycobot_interfaces__srv__StateRQ_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mycobot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mycobot_interfaces__srv__StateRQ_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mycobot_interfaces
...
/**
 * It calls
 * mycobot_interfaces__srv__StateRQ_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MYCOBOT_INTERFACES__SRV__DETAIL__STATE_RQ__FUNCTIONS_H_
