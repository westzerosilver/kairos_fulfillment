...
#ifndef MYCOBOT_INTERFACES__SRV__DETAIL__DETECTION_RQ__FUNCTIONS_H_
#define MYCOBOT_INTERFACES__SRV__DETAIL__DETECTION_RQ__FUNCTIONS_H_
...
/// Initialize srv/DetectionRQ message.
/**
...
/// Finalize srv/DetectionRQ message.
/**
...
/// Create srv/DetectionRQ message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mycobot_interfaces__srv__DetectionRQ_Request__init().
...
/// Destroy srv/DetectionRQ message.
/**
 * It calls
 * mycobot_interfaces__srv__DetectionRQ_Request__fini()
...
/// Check for srv/DetectionRQ message equality.
/**
...
/// Copy a srv/DetectionRQ message.
/**
...
/// Initialize array of srv/DetectionRQ messages.
/**
...
/// Finalize array of srv/DetectionRQ messages.
/**
 * It calls
 * mycobot_interfaces__srv__DetectionRQ_Request__fini()
...
/// Create array of srv/DetectionRQ messages.
/**
 * It allocates the memory for the array and calls
 * mycobot_interfaces__srv__DetectionRQ_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DetectionRQ messages.
/**
 * It calls
 * mycobot_interfaces__srv__DetectionRQ_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/DetectionRQ message array equality.
/**
...
/// Copy an array of srv/DetectionRQ messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mycobot_interfaces__srv__DetectionRQ_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mycobot_interfaces
...
/**
 * It calls
 * mycobot_interfaces__srv__DetectionRQ_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mycobot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mycobot_interfaces__srv__DetectionRQ_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mycobot_interfaces
...
/**
 * It calls
 * mycobot_interfaces__srv__DetectionRQ_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MYCOBOT_INTERFACES__SRV__DETAIL__DETECTION_RQ__FUNCTIONS_H_
